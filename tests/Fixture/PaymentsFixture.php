...
class PaymentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'refno' => ['type' => 'string', 'length' => 100, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            ...
            '_ptype_fk_idx' => ['type' => 'index', 'columns' => ['type'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'amount' => 1,
            'status' => 1,
            'creation_date' => '2017-02-12 14:29:51',
            'holder_id' => 1
        ],
    ];
}
